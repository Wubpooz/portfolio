...
export default function Home() {
  ...
  const homeTocItems = [
    ...
    {
      title: content.sections.certifications,
      url: "#certifications",
      depth: 2,
    },
    {
      title: content.sections.languagesAndInterests,
      url: "#languages-interests",
      depth: 2,
    },
  ...
  const tocSideClass =
    locale === "ar" ? "left-4 xl:left-10" : "right-4 xl:right-10";

  return (
    <main className="w-full min-w-0 relative">
      {/* Floating Table of Contents Minimap */}
      <div
        className={`fixed top-1/2 z-40 -translate-y-1/2 max-lg:hidden ${tocSideClass}`}
      >
