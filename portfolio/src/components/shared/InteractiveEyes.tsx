  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center gap-2 md:gap-3">
        <Eyebrow />
        <motion.div
          className="relative w-24 h-24 md:w-36 md:h-36 rounded-full border-[8px] md:border-[12px] border-foreground bg-background transition-colors duration-300 overflow-hidden"
          style={{ rotate: leftRotateSpring, scaleY: isBlinking ? 0.05 : 1 }}
          transition={isBlinking ? { duration: 0.08 } : { type: "spring", stiffness: 300, damping: 25 }}
        >
