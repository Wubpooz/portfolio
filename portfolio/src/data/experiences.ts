  ...
  fr: [
    {
      ...
      description: [
        ...
        "Pilotage et développement d'une file de calcul distribuée (de la spécification à la production) en coordonnant les équipes Dev/PM/QA/UX, augmentant la fiabilité de 40% à 100% de notre API de calcul de la synthétisabilité, même en charge.",
